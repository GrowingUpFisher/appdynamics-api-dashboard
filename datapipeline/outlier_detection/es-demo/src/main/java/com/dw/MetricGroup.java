...
public class MetricGroup {
	...
	public void populateEndpoints() {
		...
		if(groupName.equalsIgnoreCase("Process CPU Burnt (ms/min) Per Blade [POD30]")) {
		...
		} else if (groupName.equalsIgnoreCase("Heap Usage (MB)")) {
		jsonlet endpoint1 = new jsonlet();
		...
		endpointList.add(endpoint7);
		endpointList.add(endpoint8);
		} else if(groupName.equalsIgnoreCase("GC Time Spent (ms/min)")) {
		jsonlet endpoint1 = new jsonlet();
		endpoint1.setApplication("aagl_prd_POD44");
		endpoint1.setPl1("Application Infrastructure Performance");
		endpoint1.setPl3("JVM");
		...
		endpointList.add(endpoint7);
		endpointList.add(endpoint8);
		} else if(groupName.equalsIgnoreCase("Process CPU Usage %")) {
		jsonlet endpoint1 = new jsonlet();
		endpoint1.setApplication("aagl_prd_POD44");
		endpoint1.setPl1("Application Infrastructure Performance");
		endpoint1.setPl3("JVM");
		...
		endpointList.add(endpoint7);
		endpointList.add(endpoint8);
		} else if(groupName.equalsIgnoreCase("Non Heap Usage (MB)")) {
		jsonlet endpoint1 = new jsonlet();
		endpoint1.setApplication("aagl_prd_POD44");
		endpoint1.setPl1("Application Infrastructure Performance");
		endpoint1.setPl3("JVM");
